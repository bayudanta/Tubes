...
// Import Icons
import { FiActivity, FiTrash2, FiLogOut, FiPlus, FiGlobe, FiX, FiServer, FiCheckCircle, FiAlertTriangle } from "react-icons/fi";
  ...
  return (
    <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh' }}>
      <div className="card" style={{ width: '100%', maxWidth: '400px', textAlign: 'center' }}>
        ...
        {/* LOGO & JUDUL WEBSITE (BARU) */}
        <div style={{ marginBottom: '20px' }}>
            <div style={{ fontSize: '3rem', color: '#DFE0EC', marginBottom: '10px' }}>
                <FiGlobe />
            </div>
            <h1 style={{ margin: 0, fontSize: '1.8rem', textTransform: 'uppercase', letterSpacing: '2px' }}>
                Uptime Checker
            </h1>
        </div>
    ...
    <div className="container">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginBottom: '30px' }}>
        <div className="card" style={{ marginBottom: 0, textAlign: 'center', borderTop: '3px solid #4D274E' }}>
            ...
            <div style={{ color: '#757179', fontSize: '0.9rem', display:'flex', justifyContent:'center', gap:'5px', alignItems:'center' }}>
                <FiServer /> Total Systems
            </div>
        </div>
        ...
        <div className="card" style={{ marginBottom: 0, textAlign: 'center', borderTop: '3px solid #ff0055' }}>
            ...
            <div style={{ color: '#757179', fontSize: '0.9rem', display:'flex', justifyContent:'center', gap:'5px', alignItems:'center' }}>
                <FiAlertTriangle /> Critical Errors
            </div>
        </div>
      </div>
          ...
          <div key={monitor.id}>
            <div className="card flex justify-between" style={{ 
              ...
              <div className="flex gap-2">
                ...
                <button 
                  onClick={() => handleShowChart(monitor.id)} 
